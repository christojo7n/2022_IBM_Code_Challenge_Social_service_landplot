#! C:\Users\7ohn\AppData\Local\Programs\Python\Python39\python.exe
import time
...
im1 = equalize_this(image_file=r"C:\Users\7ohn\Pictures\Screenshots\Screenshot (3).png", with_plot=True)
